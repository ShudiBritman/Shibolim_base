...
def sort_by_distance(soldiers):
    homes = create_homes()
    soldiers = sorted(soldiers, key=lambda s: s.distance, reverse=True)
        ...
        for i in range(len(homes)):
            ...
            for j in range(len(home.list_of_rooms)):
                ...
                if room.add_soldier(soldier):
                    ...
                    inserted = {"ma":soldier.ma, "inserted":soldier.is_inserted,"distance":soldier.distance, "home":i, "room":j}
